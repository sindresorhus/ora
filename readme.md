...
Force enabling or disabling of the spinner. If not specified, the spinner will enable if the `stream` being run inside a TTY context and/or not in a CI environment.
